                      ...
                      <div class="featured-products__product-image">
                        ...
                        <div class="featured-products__product-btns">
                          <div class="featured-products__add-to-cart">
                            <a href="<?php echo '?add-to-cart=' . $product_id ?>" data-quantity="1" class="add_to_cart_button ajax_add_to_cart" data-product_id="<?= $product_id; ?>" data-product_sku="<?= $product_sku ; ?>" aria-label="Add to cart: “<?= $product_name;?>”" rel="nofollow">
