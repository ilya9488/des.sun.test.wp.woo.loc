...
<?php function cu_wmc_html_empty_cart(){ ?>
    <div class="cu_wmc__header">
      ...
      <button type="button" class="cu_wmc-close">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11 10.8837L1.11628 1M10.8837 1.11628L1 11" stroke="#767A7D" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
    </div>
    ...
    <h3><?php  _e('No products in the cart.', 'woo-minicart'); ?></h3>
    <a class="btn-gray" href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>"><?php _e('View Shop', 'your-text-domain'); ?></a>    
<?php } ?>
  ...
  <div class="cu_wmc__header">
    ...
    <button type="button" class="cu_wmc-close">
      <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.4 14.5L0 13.1L5.6 7.5L0 1.9L1.4 0.5L7 6.1L12.6 0.5L14 1.9L8.4 7.5L14 13.1L12.6 14.5L7 8.9L1.4 14.5Z" fill="#777777" />
      </svg>
    </button>
  </div>
            ...
            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
              '<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.26732 9.66683L0.333984 8.7335L4.06732 5.00016L0.333984 1.26683L1.26732 0.333496L5.00065 4.06683L8.73398 0.333496L9.66732 1.26683L5.93398 5.00016L9.66732 8.7335L8.73398 9.66683L5.00065 5.9335L1.26732 9.66683Z" fill="#777777"/>
                  </svg>           
                </a>',
    ...
    <div class="wmc-subtotal">
      ...
      <div class="wmc-min-free-ship">
        ...
        <div class="have-no-free-shipping <?php echo $progress_percent >= 100?'hide':''; ?>">
          ...
          <span class="mwc-price-difference"><?php echo $mwc_price_difference? $mwc_price_difference :''; ?></span>
          to cart and get 
...
<?php else: ?>
  <div class="cu_wmc-content wmc-empty">
    <?php cu_wmc_html_empty_cart(); ?>
  </div>
  <div class="cu_wmc-content-bg"></div>
